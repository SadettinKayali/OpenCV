...
capture=cv2.VideoCapture("VideoAdi.mp4")  # Eğer videodan yakalamalar yapılacaksa bu kullanılıyor.
...
while (capture.isOpened()):
    ...
    gray=cv2.cvtColor(frame,cv2.COLOR_BGR2GRAY) # RGB den Gri renge çevirmek 
    cv2.imshow("Ben",gray)
